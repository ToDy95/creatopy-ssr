...
///// custom
export function isSolidBackground(
  bg: JsonBackground | undefined
): bg is JsonBackgroundSolid {
  return bg?.type === 'solid';
}

export function isNoneBackground(
  bg: JsonBackground | undefined
): bg is JsonBackgroundNone {
  return bg?.type === 'none';
}
...
export function hasContentOffsetX(
  bg: JsonBackground | undefined
): bg is JsonBackground & { contentOffsetX: number } {
  return bg !== undefined && 'contentOffsetX' in bg;
}

export function hasContentOffsetY(
  bg: JsonBackground | undefined
): bg is JsonBackground & { contentOffsetY: number } {
  return bg !== undefined && 'contentOffsetY' in bg;
}
export function isJsonTextSlateConfigChildren(
  node: JsonTextSlateConfigNode | JsonTextSlateConfigChildren
): node is JsonTextSlateConfigChildren {
